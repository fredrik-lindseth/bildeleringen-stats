...
// Source: Miljødirektoratet / SSB. Lower than EU avg (~125 g/km) due to high EV share.
const PRIVATE_CAR_AVG_CO2 = 110;

// Methodology note for UI display
export const CO2_METHOD = {
  fleetAvg: PRIVATE_CAR_AVG_CO2,
  source: "Miljødirektoratet/SSB",
  note: "Sammenligning basert på norsk gjennomsnittlig personbilpark (~110 g CO₂/km, " +
    "Miljødirektoratet). Kun direkte utslipp (tank-to-wheel), ikke produksjon. " +
    "Forskning viser at bildelemedlemmer kjører 50–70% færre km totalt enn bileiere " +
    "(Mobility Switzerland, Martin & Shaheen 2016), noe som gir ytterligere besparelse " +
    "utover denne per-km sammenligningen.",
};
